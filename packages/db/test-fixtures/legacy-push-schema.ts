/**
 * Frozen schema used by drizzle-kit push before versioned migrations were introduced.
 * Later schema changes must be represented by migrations and must not update this fixture.
 */
